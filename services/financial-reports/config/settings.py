"""
Configuration Management for Financial Reports
...
class Settings:
    ...
    def _load_from_env(self):
        ...
        self._summary_api_key = os.getenv('SUMMARY_API_KEY')
        self._summary_model = os.getenv('SUMMARY_MODEL')
    ...
    @property
    def summary_api_url(self) -> str:
        if self.dev_mode:
            return self._summary_api_url
        return os.getenv('SUMMARY_API_URL')

    @property
    def summary_api_key(self) -> str:
        if self.dev_mode:
            return self._summary_api_key
